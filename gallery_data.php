                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($row["gambar_gallery"] != '') {
                                    if (file_exists('gallery/' . $row["gambar_gallery"] . '')) {
                                ?>
                                        <img src="gallery/<?= $row["gambar_gallery"] ?>" width="350">
                                <?php
                                    }
                                }
                                ?>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        if ($row["gambar_gallery"] != '') {
                                                            if (file_exists('gallery/' . $row["gambar_gallery"] . '')) {
                                                        ?>
                                                                <br><img src="gallery/<?= $row["gambar_gallery"] ?>" width="100">
                                                        <?php
                                                            }
                                                        }
                                                        ?>
                                                        <input type="hidden" name="gambar_lama" value="<?= $row["gambar_gallery"] ?>">
                                                    </div>
                                            ...
                                            <form method="post" action="" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="hidden" name="id" value="<?= $row["id"] ?>">
                                                        <input type="hidden" name="gambar" value="<?= $row["gambar_gallery"] ?>">
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
